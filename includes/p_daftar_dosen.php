	  ...
	  ?>
		<tr>
		  ...
		  <td>
			...
			<a href="?page=process&o=d&id=<?=$data[$i][0]?>&tud=1" rel="tooltip" title="Hapus" class="btn btn-mini btn-danger" onclick="return konfirmasi()"><i class="icon-remove icon-white"></i></a>
		  </td>
		</tr>
	  <?php } ?>
	  </tbody>
...
<div class="modal hide fade" id="modalDetail<?=$i?>" tabindex="-1" role="dialog" aria-labelledby="modalDetail<?=$i?>Label" aria-hidden="true">
  <div class="modal-header">
    ...
    <h4 id="modalDetail<?=$i?>">Detail Dosen</h4>
  </div>
